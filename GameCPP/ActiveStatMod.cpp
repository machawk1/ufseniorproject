...
ActiveStatMod::ActiveStatMod(AbilityNameType name, int buyCost, int useCost, int minRange, int maxRange, int radius, int cooldown,
	int hpMod, int apMod, int movementMod, int toHitMod, int mitigationMod, int dodgeMod, int duration)
{
	ID = GLOBAL_ID++;
	this->name = name;
